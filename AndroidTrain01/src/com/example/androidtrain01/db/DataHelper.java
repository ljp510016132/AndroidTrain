package com.example.androidtrain01.db;
...
import com.example.androidtrain01.utils.BitMapHelper;
...
public class DataHelper {
	...
	public List<UserInfo> GetUserList(Boolean isSimple) {
		...
		// Cursor cursor = db.query(SqliteHelper.TB_NAME, null, null, null,
		// null,
	...
	public void SaveUserInfos(List<UserInfo> userInfos) {
		for (UserInfo userInfo : userInfos) {
			if(userInfo.getUserIcon()!=null){
				Bitmap bitmap=BitMapHelper.drawableToBitmap(userInfo.getUserIcon());
				SaveUserInfo(userInfo, BitMapHelper.Bitmap2Bytes(bitmap));
			}
	...
	public int DelUserInfo(String UserId) {
		int id = db.delete(SqliteHelper.TB_NAME, UserInfo.USERID + "=?",
				new String[] { UserId });
